...
[![R-CMD-check](https://github.com/jhuwit/actisensorlog/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/jhuwit/actisensorlog/actions/workflows/R-CMD-check.yaml)
[![Codecov test coverage](https://codecov.io/gh/jhuwit/actisensorlog/branch/main/graph/badge.svg)](https://codecov.io/gh/jhuwit/actisensorlog?branch=main)
<!-- badges: end -->

# actisensorlog

`actisensorlog` processes SensorLog and SensorLogger exports. The package
focuses on timestamp normalization, distance calculations,
duplicate-time checks, and daily summaries.

Core entry points:

- `acti_process_sensorlog()` for duplicate checking, home-distance
  calculations, and timezone handling
- `acti_sensorlog_process_time()` for parsing SensorLog timestamps
- `acti_minute_sensorlog()` and `acti_summarize_sensorlog()` for minute and
  daily summaries
