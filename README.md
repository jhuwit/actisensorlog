...
[![Codecov test
coverage](https://codecov.io/gh/jhuwit/actisensorlog/branch/main/graph/badge.svg)](https://app.codecov.io/gh/jhuwit/actisensorlog?branch=main)
<!-- badges: end -->
...
- `acti_minute_sensorlog()` and `acti_summarize_sensorlog()` for minute
  and daily summaries
