...
acti_summarize_sensorlog = function(data) {
  ...
  data = acti_minute_sensorlog(data, seconds = 60L)
...
#' @rdname acti_summarize_sensorlog
#' @export
acti_summarise_sensorlog = acti_summarize_sensorlog
...
#' `acti_summarize_distance_sensorlog`, summarization is done depending on how the
#' data is grouped.
#' @export
acti_minute_sensorlog = function(data, seconds = 60L) {
...
#' @rdname acti_summarize_sensorlog
#' @export
acti_summarize_distance_sensorlog = function(data) {
