...
- `calculate_measures()` for summary metrics such as AI, MAD, MIMS, and
  AC
- [`acti_calculate_counts()`](https://rdrr.io/pkg/actimetrics/man/acti_calculate_counts.html)
  and
  [`acti_process()`](https://rdrr.io/pkg/actimetrics/man/acti_process.html)
  for count and wear overlays
- [`mims_default_processing()`](https://rdrr.io/pkg/actimetrics/man/mims_default_processing.html)
  for the default MIMS preprocessing chain
- [`acti_calibrate()`](https://rdrr.io/pkg/actimetrics/man/calibrate.html)
